...
When filing an issue, please check [existing open](https://github.com/aws/aws-logging-dotnet/issues), or [recently closed](https://github.com/aws/aws-logging-dotnet/issues?utf8=%E2%9C%93&q=is%3Aissue%20is%3Aclosed%20), issues to make sure somebody else hasn't already 
...
```
autover change --project-name "AWS.Logger.Core" -m "Fixed an issue causing a failure somewhere
```
